...
const PostPage = () => {
    return (
        <Layout>
            <header className="intro-header" style={{ backgroundImage: "url('vendor/img/post-bg.jpg')" }}>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                            ...
                            <a href="#">
                                <Image className="img-responsive" width={500} height={300} src="/vendor/img/post-sample-image.jpg" alt="" />
                            </a>
